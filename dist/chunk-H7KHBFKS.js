  ...
  "node_modules/.store/supports-color-npm-9.4.0-a415f39758/package/index.js"() {
    ...
    supportsColor = {
      stdout: createSupportsColor({
        isTTY: _tty2.default.isatty(1)
      }),
      stderr: createSupportsColor({
        isTTY: _tty2.default.isatty(2)
      })
    };
      ...
      for (const request of module.requests.filter((x) => Object.keys(x.match).length > 0)) {
        ...
        for await (const exe of this.executors) {
          ...
          if (exe.init) {
            ...
            if (!disabled) {
              debug2(`init ${module.name}	 -> ${_optionalChain([exe, 'optionalAccess', _2 => _2.match, 'access', _3 => _3.module])} 	${_optionalChain([exe, 'optionalAccess', _4 => _4.description]) ? ` -> ${exe.description}` : ""}`);
            ...
            debug2(`init* ${module.name}	 -> ${_optionalChain([exe, 'optionalAccess', _5 => _5.match, 'access', _6 => _6.module])} 	${_optionalChain([exe, 'optionalAccess', _7 => _7.description]) ? ` -> ${exe.description}` : ""}`);
            requestExecutors.push({
              context: {},
              executor: exe
            });
...
//# sourceMappingURL=chunk-H7KHBFKS.js.map